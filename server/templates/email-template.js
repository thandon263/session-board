export default {
    html: function(name, url, time, resetCode) {
    ...
    <!--<![endif]-->
        <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
          ...
          <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
              <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;"><strong>Welcome to the movement, ${name}!</strong></h1><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br />
    Hi ${name}, <br/><br/>You have recently requested to reset your password for your #MoveTheDial App Account.</p>
        <p>The Reset Code is valid for 24 hours, copy the reset code below.</p>
        <p> Reset Code: <b>${resetCode}</b></p>
        If you did not request a reset password, please ignore this email. This password reset
          </div>
        </div>
          ...
          <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
            <![if !mso]><a style="border-radius: 20px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #01AFD1;font-family: Ubuntu, sans-serif;" href="${url}/reset-password?code=${resetCode}">Reset Password</a><![endif]>
          ...
          <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
          Thanks, <br/>
          The team at #MoveTheDial
        </div>
            
                <div style="Margin-left: 20px;Margin-right: 20px;">
          <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
            <p style="padding: 10% 15%; Margin-top: 0;Margin-bottom: 20px; text-align: center"><em>If you are having trouble clicking the reset password button copy and paste the Reset Code in the App Reset Password screen to validate the reset password request.</em></p>
          </div>
        </div>
